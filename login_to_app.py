...
class LoginToApp:
    def __init__(self, login_tab, root, tabview):
        ...
        password_from_user = ctk.CTkEntry(login_tab, show='*', width=160)
        ...
        self.login_username = ctk.CTkEntry(login_tab, width=160)
        ...
        add_login_button = ctk.CTkButton(login_tab, corner_radius=10, text='Login', width=140, command=handle_login)
